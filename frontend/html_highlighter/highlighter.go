...
var USEINNER string = formatStr("use innerspec ",BOLD) + formatInner("$name")
var BOLD string = "font-weight:bold;"
var INNERCOLOR string = "color:#4d8491;"
...
func formatInner(s string) string {
  return formatStr(s, INNERCOLOR + BOLD)
}
