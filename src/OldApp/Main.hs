module OldApp.Main where
import Example.Empirical
import Example.STExample (x)
import Example.SliceEx (spec)
import qualified Example.UAVSpec (spec)
import qualified Example.DynMTLEx (spec)
...
import System.IO
import InFromFile
import qualified OldApp.QuickCheck as QC (main)
...
importedSpec = Example.DynMTLEx.spec
